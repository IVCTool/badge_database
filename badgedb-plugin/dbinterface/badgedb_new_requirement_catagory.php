...
//TODO we need to get the requirements from the database

//TODO we then need to return the interface;  there is a public and admin version,
//    so we need to check if the user is logged in and has the right permission.

//TODO return the interface as a string.

$returnval = '<h1>Interoperability Requirement Catagories</h1>
<p>&nbsp;</p>
