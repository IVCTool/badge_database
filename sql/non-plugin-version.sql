...
CREATE DATABASE `badgesdb` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;
USE `badgesdb`;
...
INSERT INTO `abstracttcs` (`filename`, `id`, `identifier`, `name`, `description`, `version`) VALUES
('UberTestAbstractTestCase.txt',	9,	'ATC-Test',	'More than a test',	'Still a test but getting there.',	'1'),
('TestAbstractTestCase.txt',	11,	'ATC-Test2',	'Just a simple test',	'This describes how to profit',	'1'),
('NoExecCase.txt',	12,	'ATC-NoExecCase',	'No implementation',	'This is just for testing the coverage reports.',	'1');

DROP TABLE IF EXISTS `abstracttcs_has_requirements`;
CREATE TABLE `abstracttcs_has_requirements` (
  `abstracttcs_id` int(10) unsigned NOT NULL,
  `requirements_id` int(10) unsigned NOT NULL,
  KEY `requirements_id` (`requirements_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

INSERT INTO `abstracttcs_has_requirements` (`abstracttcs_id`, `requirements_id`) VALUES
(12,	5),
(11,	5),
(9,	1),
(12,	2),
...
INSERT INTO `badges` (`id`, `description`, `graphicfile`, `identifier`) VALUES
...
INSERT INTO `badges_has_badges` (`badges_id`, `badges_id_dependency`) VALUES
(21,	25),
(22,	26),
(23,	24),
(24,	20),
...
INSERT INTO `badges_has_requirements` (`requirements_id`, `badges_id`) VALUES
(1,	20),
(2,	20),
(5,	20),
(6,	20),
...
INSERT INTO `executabletcs` (`id`, `Description`, `classname`, `version`, `abstracttcs_id`) VALUES
(1,	'Uber test implementation',	'ca.ubertest',	'1',	9),
(2,	'This describes how to profit',	'ca.profit',	'1',	11);
...
INSERT INTO `reqcategories` (`name`, `description`, `identifier`, `id`) VALUES
...
INSERT INTO `requirements` (`id`, `identifier`, `description`, `reqcategories_id`) VALUES
...
INSERT INTO `users` (`id`, `username`, `password`, `email`, `role`, `approved`) VALUES
(18,	'me',	'5f4dcc3b5aa765d61d8327deb882cf99',	'me@hotmail.com',	'none',	1);
