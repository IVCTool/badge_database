...
INSERT INTO `abstracttcs` (`filename`, `id`, `identifier`, `name`, `description`, `requirements_id`, `version`) VALUES
('UberTestAbstractTestCase.txt',	9,	'ATC-Test',	'More than a test',	'Still a test but getting there.',	149,	'1'),
('TestAbstractTestCase.txt',	11,	'ATC-Test2',	'Just a simple test',	'This describes how to profit',	5,	'1'),
('NoExecCase.txt',	12,	'ATC-NoExecCase',	'No implementation',	'This is just for testing the coverage reports.',	150,	'1');
...
(13,	'allan.gillis',	'e4e6c4f927e596b61d88ec502e5c30ea',	'allan.gillis@drdc-rddc.gc.ca',	'none',	1),
(12,	'regis.mauget',	'9803c9febcaf13251ade47a2e0319f41',	'regis.mauget@capgemini.com',	'none',	1);
